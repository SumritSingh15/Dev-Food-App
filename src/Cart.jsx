...
const Cart = () => {
  ...
  return (
    <div className="p-5 flex flex-col ml-[500px] gap-5">
      {items.length === 0 ? (
        <h2 className="text-white text-2xl">Your cart is empty</h2>
      ) : (
        items.map((item) => (
          <div 
            key={item.id}
            className="w-[800px] h-50 bg-blue-800 rounded-xl p-4 flex justify-between shadow-lg hover:scale-105 transition"
          >
